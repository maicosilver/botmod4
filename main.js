...
global.owner = ['558896724995','17792077393'] // Put your number here
    ...
    m.exp += 1
      ...
      let _prefix = plugin.customPrefix ? plugin.customPrefix : conn.prefix ? conn.prefix : global.prefix
        ...
        if (!isPrems && global.DATABASE._data.users[m.sender].limit < m.limit * 1 && plugin.limit) {
          this.reply(m.chat, `Você excedeu seu limite, compre por *${usedPrefix}buy*`, m)
...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    admin: 'Este comando é apenas para adms do grupo!',
    botAdmin: 'Torne o bot um Adm para usar este comando!'
  }[type]
